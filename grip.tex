...
\begin{document}
	...
	\begin{titlepage}
		...
		\begin{flushright}
			{\large Radili: Nikola Stanojević 107/2022}\\[0.8cm]
	...
	Parametre $r$ i $a$ procenjujemo aproksimacijom izvoda metodom \textbf{unaprednih razlika}
	prvog reda (forward Euler), $\frac{\mathrm{d}f}{\mathrm{d}t}\big|_{t} \approx f(t+1)-f(t)$,
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.88\textwidth]{fig_scenariji.eps}
